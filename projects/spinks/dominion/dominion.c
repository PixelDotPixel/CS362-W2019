...
//---------------------------------------------------------------------------------------------------Function Version of Card Effects Starts Here--------------------------------------------------------

int cardEffect_Adventurer(struct gameState *state){
	int currentPlayer = whoseTurn(state);
	int cardDrawn;
	int temphand[MAX_HAND];
    int drawntreasure = 1;								// moved above the if statement
...
//+4 Cards
int cardEffect_Council_Room(struct gameState *state, int handPos){
	int currentPlayer = whoseTurn(state);
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case council_room:
	return cardEffect_Council_Room(state, handPos);
    ...
    case village:
	return cardEffect_Village(state, handPos);
